...
def register_ui_adapters(*, read_only: bool = False):
    ...
    try:
        ...
        def _account_factory():
            logic = _AccountLogic(ctx.account_controller, settings_store=ctx.settings_store)
    ...
    try:
        ...
        def _clock_factory():
            logic = _ClockLogic(ctx.clock_controller)
    ...
    try:
        ...
        def _agents_factory():
            logic = _AgentsLogic(ctx.agent_controller, ctx.agent_service)
