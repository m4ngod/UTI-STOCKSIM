...
def _ensure_sim_time_columns():
    ...
    for t in tables:
        ...
        try:
            ...
            if t in ('orders', 'trades', 'ledgers', 'order_events', 'agent_bindings', 'account_equity_snapshots', 'event_log', 'snapshots_1s', 'bars_1m', 'bars_1h', 'bars_1d') and 'run_id' not in cols:
