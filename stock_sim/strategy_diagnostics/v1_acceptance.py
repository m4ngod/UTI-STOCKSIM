...
V1_ALLOWED_APPLICATION_COMMANDS = (
    ...
    "compose_formal_scenario_set_command",
    ...
    "materialize_reference_path",
    "materialize_scenario_recipe_command",
    ...
    "replay_scenario_materialization_command",
    "recipe_authoring_capabilities",
    ...
    "retry_scenario_materialization_command",
    "revise_diagnostic_task_configuration",
    "revise_recipe_version",
    "revise_scenario_recipe_draft_command",
    "run_baseline_campaign",
    "scenario_lab_execution_resolutions",
    "scenario_lab_formal_scenario_sets",
    "scenario_lab_selection_contexts",
    "start",
    ...
    "scenario_materialization_task_handles",
    "select_formal_scenario_set_command",
    ...
    "validate_recipe_draft",
    "validate_scenario_recipe_draft_command",
)
